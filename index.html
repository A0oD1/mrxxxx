...
<body>
    <div class="image-container">
        <img src="https://media1.tenor.com/m/kMKu9-I99k8AAAAC/alucard-hellsing.gif" alt="Sorry i know its painful">
    </div>
    <audio autoplay loop>
        <source src="aa.mp3" type="audio/mpeg">
        Your browser does not support the audio element.
    </audio>
     <div class="text">Tonight's the night</div>
    ...
    <div class="text">By : Dexter  & harrison xD</div>
